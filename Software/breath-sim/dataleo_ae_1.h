...
int const vol_size = 10; //The number of the curve points (for square flow set to 2, testing flow to 4, crying flow to 10)
...
float vol_curve_max = 6; //total volume of the curve, usually the maximum value of the curve